        ...
        <div className="box box-danger">
          <div className="box-content">
            ...
            <table className="" width="100%">
              <thead>
                <tr>
                  <th className="text-center pb-2">Nit</th>
                  <th className="text-center pb-2">Razon Social</th>
                  <th className="text-center pb-2">Correo electronico</th>
                  <th className="text-center pb-2">Telefono</th>
                  <th className="text-center pb-2">Direccion</th>
                  <th className="text-center pb-2">Ciudad</th>
                </tr>
              </thead>
              <tbody>
                {proveedores.map((proveedor, index) => (
                  <tr key={index}>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.nit}</td>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.razon_social}</td>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.correo_electronico}</td>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.telefono}</td>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.direccion}</td>
                    <td className="text-center border-bottom pt-0 pb-2">{proveedor.ciudad}</td>
